...
1. Выполненное задание необходимо отправить ответным письмом по email.
...
2. форму, через которую можно загрузить файл на сервер,
...
3. Валидный файл формата xml.
3. Размер до 10Гб.
3. Значения узлов в xml строковые, но могут содержать числа как подстроку. Числа могут быть как дробные, так и целые.
